...
> **Current snapshot:** 377 registered node types · 70 multi-node system branches · 2 source collections · 4 shared roles · no fixed fleet limit
...
The current Devices import adds 70 source project directories and 304 child node types. Those counts are discovered from the registries rather than imposed as limits; both collections can keep growing.
