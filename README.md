...
> **Current snapshot:** 347 registered node types · 65 multi-node system branches · 2 source collections · 4 shared roles · no fixed fleet limit
...
The current Devices import adds 65 source project directories and 276 child node types. Those counts are discovered from the registries rather than imposed as limits; both collections can keep growing.
